DEVICE=cuda:1
BRIGHTNESS_CLAMP=1
BRIGHTNESS_REGULARIZER_COEFF=1
CONTRAST_CLAMP=1
PSF_LOSS_WEIGHT=1.0
...
# RESULT_PATH=./example/asset/ckpt/fixImgForm_stereo_E2E_RGB_daloss1_indePSF_meta7800_864_f9_RGB_IMX304_arr22_BrightRegular05
RESULT_PATH=./example/asset/ckpt/single_sensor_new_validate_new_normalizer
# PARAM=./example/asset/config/param_MV_metasurface_pitch500nm.py
# PARAM=./example/asset/config/param_MV_metasurface_pitch345nm.py
# PARAM=./example/asset/config/param_MV_metasurface_RGB_pitch395nm.py
# PARAM=./example/asset/config/param_MV_metasurface_RGB_pitch395nm_1024.py
# PARAM=./example/asset/config/param_IMX304_DOE.py
# PARAM=./example/asset/config/param_IMX304_synMeta_RGB_pitch395nm_2by2_864.py
PARAM=./example/asset/config/param_singlesensor_synMeta.py
...
OBSTRUCTION=dirt # single_image, dirt
BATCH_SIZE=1
SAVE_FREQ=800
LOG_FREQ=100
N_EPOCHS=1000
...
# python train_metasurface.py \
# python train_synthetic_aperture_metasurface.py \
python train_synthetic_aperture_single_sensor_metasurface.py \
--use_dataset \
--constant_wvl_phase \
--train_RGB \
--use_da_loss \
